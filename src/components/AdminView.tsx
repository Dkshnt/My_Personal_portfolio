              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 rounded-xl border text-xs focus:ring-1 focus:outline-none transition-all bg-white text-neutral-900 ${
                      isProd 
            ...
            <form onSubmit={handleSaveChanges} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-xl border text-xs focus:ring-1 focus:outline-none transition-all bg-white text-neutral-900 ${
                    isProd 
                      ? 'border-sage-200 focus:ring-sage-700'
                      : 'border-neutral-850 focus:ring-teal-400'
                  }`}
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-9 pr-3 py-2 rounded-lg border text-xs focus:ring-1 focus:outline-none transition-all bg-white text-neutral-900 ${
                          isProd 
                            ? 'border-sage-200 focus:ring-sage-700'
                            : 'border-neutral-850 focus:ring-teal-400'
                        }`}
                        ...
                        {block.type === 'text' && (
                          <div className="space-y-1">
                            ...
                            <textarea
                              ...
                              rows={4}
                              className={`w-full p-3 rounded-xl border text-xs focus:ring-1 focus:outline-none transition-all bg-white text-neutral-900 ${
                                isProd 
                                  ? 'border-sage-200 focus:ring-sage-700'
                            ...
                            <div className="flex gap-4">
                              ...
                              <div className="space-y-1 flex-grow">
                                ...
                                <input
                                  ...
                                  className={`w-full px-3 py-1.5 rounded-lg border text-xs focus:ring-1 focus:outline-none transition-all bg-white text-neutral-900 ${
                                    isProd 
                                      ? 'border-sage-200 focus:ring-sage-700'
                                      : 'border-neutral-800 focus:ring-teal-400'
                                  }`}
